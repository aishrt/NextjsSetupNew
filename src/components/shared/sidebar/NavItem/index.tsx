...
export default function NavItem({
  ...
  const active = removeQueryStringAndMatch(item.href, pathDirect).isMatch;
  ...
  const ListItemStyled = styled(ListItemButton)(() => ({
    ...
    fontWeight:
      level > 1 && active ? "600 !important" : "400",
  ...
  return (
    <List component="li" disablePadding key={item?.id && item.title}>
      <Link title={item.title} href={item.href} style={{ textDecoration: "none" }}>
        <ListItemStyled
          // {...listItemProps}
