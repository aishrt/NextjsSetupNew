...
export default function NavCollapse({
  ...
  if (item && !isEmpty(item.children) && item.children) {
    isOpen =  item.children.some(itm => removeQueryStringAndMatch(itm.href, pathDirect).isMatch);
  }
  ...
  return (
    <>
      ...
      {(!isEmpty(item.children) && item.children && open) &&
        item?.children.map((subItem: any) => {
          return (
            <List
              ...
              className="sublist"
            >
              <Link href={subItem.href} title={subItem.title} style={{ textDecoration: "none" }}>
                <ListItemStyled
                  disabled={subItem?.disabled}
                  selected={removeQueryStringAndMatch(subItem.href, pathDirect).isMatch}
                  sx={{
                    "&:hover": {
                      ".MuiListItemIcon-root": {
