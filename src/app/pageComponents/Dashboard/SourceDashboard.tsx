          ...
          <div className="dashboardTopCard">
            <div className="container-fluid">
              <div className="row">
                ...
                {props?.host_name == "null" || props?.host_name == "" ? null : <div className="col-lg-6 sourceCard mt-3">
                  <div className="card">
                    <div className="card-body">
                      <div className="dashboardData">
                        <div className="source-data">
                                          ...
                                          <>
                                            ...
                                            <span className="">
                                              {item.compliant_trend_value ==
                                                ...
                                                <>
                                                  <span
                                                    className={`${item?.compliant_trend ==
                                                      "decrease"
                                                      ? "redColor"
                                        ...
                                        <div>
                                          {props?.start_Date !==
                                            ...
                                            <a
                                              ...
                                              href={`/dashboard/compliant-dashboard/?row_source_ip=${item.source_ip}&volume=${item.rows_count}&complaince=${item.compliant_percentage}&policy_published_domain=${item.header_from}&spf=${item.spf_percentage}&dkim=${item.dkim_percentage}&start_date=${dayjs(props?.start_Date).format("YYYY-MM-DD")}&end_date=${dayjs(props?.end_Date).format("YYYY-MM-DD")}&page=1&page_size=10`}
                                            >
                                              <img
                                                alt={``}
